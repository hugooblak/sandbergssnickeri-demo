...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'sandbergssnickeri-leads' ),
				'storm'       => __( 'Storm or hail damage', 'sandbergssnickeri-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'sandbergssnickeri-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'sandbergssnickeri-leads' ),
				'not-sure'    => __( 'Vet inte än', 'sandbergssnickeri-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'sandbergssnickeri-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'sandbergssnickeri-leads' ),
				'research' => __( 'Jag kollar bara priser', 'sandbergssnickeri-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'sandbergssnickeri-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'sandbergssnickeri-leads' ),
		'contacted' => __( 'Kontaktad', 'sandbergssnickeri-leads' ),
		'quoted'    => __( 'Quote sent', 'sandbergssnickeri-leads' ),
		'won'       => __( 'Won', 'sandbergssnickeri-leads' ),
		'lost'      => __( 'Lost', 'sandbergssnickeri-leads' ),
		'spam'      => __( 'Misstänkt spam', 'sandbergssnickeri-leads' ),
	);
}
